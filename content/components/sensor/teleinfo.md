...
title: "Teleinformation from Linky electrical meter"
params:
  seo:
    description: Instructions for setting up French Teleinformation
    image: teleinfo.jpg
...
French electrical meter using Teleinformation ([datasheet](https://www.enedis.fr/media/2035/download)). It works with Linky electrical meter but also legacy EDF electrical meter.

{{< img src="teleinfo-full.jpg" alt="Image" caption="Linky electrical meter" width="50.0%" class="align-center" >}}

---

A simple electronic circuit assembly with an optocoupler and a resistor could
...
set the baud rate to 9600bps if meter is configured to work in standard
mode or 1200bps in historical mode. To find out which mode you are using,
simply press -/+ buttons on the meter and look for `Standard mode` or
`Historical mode` as below.

{{< img src="teleinfo-standard.jpg" alt="Image" caption="Linky electrical meter configured in standard mode." width="50.0%" class="align-center" >}}

---

{{< img src="teleinfo-historical.jpg" alt="Image" caption="Linky electrical meter configured in historical mode." width="50.0%" class="align-center" >}}
...
- **historical_mode** (*Optional*): Whether to use historical mode or standard mode.
  With historical mode, baudrate of 1200 must be used whereas 9600 must be used in standard mode. Defaults to `false`.
...
```yaml
# Example sensor configuration (unit_of_measurement, device_class, etc. are auto-configured)
sensor:
  - platform: teleinfo
    tag_name: "HCHC"
