...
- **command** (*Required*, string, [templatable](/guides/automations#all-actions)): The command string to send.
...
sensor:
  - platform: emontx
    tag_name: "V1"  # Use "Vrms" for single-phase, "V1"-"V3" for multi-phase
    name: "Voltage"
  - platform: emontx
    tag_name: "P1"
    name: "Power CT1"
