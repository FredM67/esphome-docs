...
- **Apparent Power**: Calculates the apparent power based on the voltage and current readings.
- **Frequency**: Measures the frequency of the mains supply.
...
Apparent power sensors have the following default configuration:

- Unit of Measurement: VA (Volt-Amps)
...
Frequency sensors have the following default configuration:
...
#### Apparent Power (AP1-AP12)

Apparent power sensors follow the same indexing as the CT inputs:

- **AP1-AP6**: Apparent power for CT1-CT6 on the standard EmonTx
- **AP7-AP12**: Apparent power for CT7-CT12 when an expansion board is present

#### Frequency (F)

The `F` sensor reports the mains frequency as a single, un-numbered tag — there is no `F1`/`F2` variant.
