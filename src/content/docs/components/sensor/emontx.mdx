...
import emontx5Img from './images/emontx5.jpg';
...
If you configure the `mqtt` option, you will need to define the [MQTT component](/components/mqtt) in your configuration.
