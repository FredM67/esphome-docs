...
| `V` | Voltage (single-phase) | V | Sent in centivolts by the router; the component converts it automatically |
| `V1`, `V2`, `V3` | Voltage per phase | V | Three-phase systems only; sent in centivolts and converted automatically |
...
| `T1`, `T2`, ... | Temperature sensors | °C | Sent in centi-degrees by the router; the component converts it automatically |
